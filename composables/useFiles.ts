...
export const useFiles = () => {
    ...
    /* FILE TYPE SEARCH */
    const filetypeSearchIsOpen = useState('filetype-search-is-open', () => ref<boolean>(false));
    const filetypeSearchSelectedValue = useState('filetype-search-value', () => ref<string>('')); // BundledLanguage
    ...
    /* DOWNLOADER */
    const fileNameOfFileToDownload = useState('file-name-of-file-to-download', () => ref<string>(''));
    ...
    /* VERSION SELECT */
    const selectedFileVersionId = useState('selected-file-version-id', () => ref<string>(''));
