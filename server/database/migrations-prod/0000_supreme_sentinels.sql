...
/*
DO $$ BEGIN
 CREATE TYPE "public"."ai_model_enum" AS ENUM('OpenAssistant/oasst-sft-4-pythia-12b-epoch-3.5', 'mistralai/Mistral-7B-Instruct-v0.1', 'meta-llama/Meta-Llama-3-8B-Instruct');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "github_app_installation_repository" ADD CONSTRAINT "github_app_installation_repository_github_app_installation_id_g" FOREIGN KEY ("github_app_installation_id") REFERENCES "public"."github_app_installation"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chat_conversation_share" ADD CONSTRAINT "chat_conversation_share_chat_conversation_id_chat_conversation_" FOREIGN KEY ("chat_conversation_id") REFERENCES "public"."chat_conversation"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chat_conversation_share_whitelist_entry" ADD CONSTRAINT "chat_conversation_share_whitelist_entry_whitelisted_neptun_user" FOREIGN KEY ("whitelisted_neptun_user_id") REFERENCES "public"."neptun_user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chat_conversation_share_whitelist_entry" ADD CONSTRAINT "chat_conversation_share_whitelist_entry_chat_conversation_share" FOREIGN KEY ("chat_conversation_share_id") REFERENCES "public"."chat_conversation_share"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
