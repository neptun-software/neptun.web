...
export async function createChatConversationShareWhitelistEntries(data: ChatConversationShareWhitelistToCreate[]) {
...
export async function readAllChatConversationShareWhitelistEntries(share_id: ReadChatConversationShare['share_uuid']) {
...
export async function deleteChatConversationShareWhitelistEntry(id: ReadChatConversationShareWhitelist['id']) {
