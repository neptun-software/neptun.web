...
import { chat_conversation_share, chat_conversation_share_whitelist_entry, type ReadChatConversationShare, type ChatConversationShareWhitelistToCreate, type ReadChatConversationShareWhitelist } from "~/lib/types/database.tables/schema"
...
export const readAllChatConversationShareWhitelistEntries = async (share_id: ReadChatConversationShare["share_uuid"]) => {
    const chatConversationShareWhitelistEntry = await db
        .query
