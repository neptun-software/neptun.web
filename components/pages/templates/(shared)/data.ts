...
const template = {
  description: 'NeptunAI static template',
...
const FULL_STACK_WEBSITE_STARTER = {
  DOCKER_COMPOSE: `
version: '3.8'
...
`,
  POSTGRES_DATAGRIP_SOURCE_CONFIGURATION: `
#DataSourceSettings#
...
#END#
`,
  REDIS_DATAGRIP_SOURCE_CONFIGURATION: `
#DataSourceSettings#
...
const POSTGRES_DATABASE_STARTER = {
  DOCKER_COMPOSE: `
version: '3.8'
    ...
    templates: [
      {
        ...
        language: 'yaml',
        extension: 'yml',
        text: FULL_STACK_WEBSITE_STARTER.DOCKER_COMPOSE,
      },
      {
        ...template,
        ...
        language: 'sql',
        extension: 'sql',
        text: FULL_STACK_WEBSITE_STARTER.POSTGRES_EXTENSIONS,
      },
      {
        ...template,
    ...
    templates: [
      {
        ...
        language: 'yaml',
        extension: 'yml',
        text: POSTGRES_DATABASE_STARTER.DOCKER_COMPOSE,
      },
      {
        ...template,
        file_name: 'postgres.extensions.sql',
    ...
    templates: [
      {
        ...
        language: 'yaml',
        extension: 'yml',
        text: REDIS_DATABASE_STARTER.DOCKER_COMPOSE,
      },
      {
        ...template,
        file_name: 'redis.conf',
