...
--
-- Name: context_file_category; Type: TYPE; Schema: public; Owner: nptn_owner
--
...
ALTER TYPE public.context_file_category OWNER TO nptn_owner;

--
-- Name: context_file_type; Type: TYPE; Schema: public; Owner: nptn_owner
--
...
ALTER TYPE public.context_file_type OWNER TO nptn_owner;

--
-- Name: import_source_type; Type: TYPE; Schema: public; Owner: nptn_owner
--
...
ALTER TYPE public.import_source_type OWNER TO nptn_owner;
...
--
-- Name: programming_language; Type: TYPE; Schema: public; Owner: nptn_owner
--
...
ALTER TYPE public.programming_language OWNER TO nptn_owner;

--
-- Name: project_type; Type: TYPE; Schema: public; Owner: nptn_owner
--
...
ALTER TYPE public.project_type OWNER TO nptn_owner;
